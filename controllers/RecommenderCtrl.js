...
module.exports = {
    ...
    getMostPopular: (request, response) => {
        console.log( request.query.deviceId);
        console.log('http://' + cublickIngestConfig.apiRecommenderUrl + ':8080/mostPopularItems' );
        httpRequest.get('http://' + cublickIngestConfig.apiRecommenderUrl + ':8080/mostPopularItems', (resp) => {
        let data = '';
